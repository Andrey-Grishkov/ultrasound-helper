    ...
    <div className="calc-form">
      <div className="calc-form__photo-container">
        <p className="calc-form__text">
          ...
          <b>L</b> — под углом 90гр к Sep, по касательной к диафрагме от медиальной до латеральной точек к ткани грудной стенки.
        </p>
      ...
      <p className="calc-form__description">В основе калькулятора лежит способ определения объема свободной жидкости в плевральной полости, полученный
        экспериментально и запатентованный Иркутским государственным медицинским университетом в 2022 году. Точность
        расчетов 50мл. Ссылка на патент.</p>
    </div>
  );
};
